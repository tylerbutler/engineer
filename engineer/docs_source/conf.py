# -*- coding: utf-8 -*-
#
# APP_NAME documentation build configuration file, created by
...
to_add = path(__file__).dirname().dirname().dirname().abspath()
...
copyright = u'2011-2014, %s' % AUTHOR_NAME
...
htmlhelp_basename = '%sdoc' % APP_NAME
...
man_pages = [
    ('index', APP_NAME, u'%s Documentation' % APP_NAME,
     [AUTHOR_NAME], 1)
]
