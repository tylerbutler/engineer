...
*The following is John Gruber's [basic syntax overview][gist] of Markdown
taken from his site. It's used here to show you how a Markdown post looks
once Engineer has transformed it into a webpage.*

[Getting the Gist of Markdown's Formatting Syntax][gist]
--------------------------------------------------------
